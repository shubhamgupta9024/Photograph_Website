...
def stills():
    ...
    # Filter out related images on stills main page so it stays clean as per your request
...
def view_image(image_name):
    ...
    # ✅ Get only the same stills as shown on /stills page
    media = get_media_files()
    filtered_stills = [
        os.path.basename(img)
        for img in media['stills']
    ]

    return render_template(
        'view_image.html',
        image_name=safe_image_name,
        all_stills=filtered_stills
    )
